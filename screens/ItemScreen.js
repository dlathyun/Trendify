...
const ItemScreen = ({ route, navigation }) => {
  ...
  const { title, description, price, additionalNote, img, itemOwner, itemNum } =
    route.params;
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      {additionalNote && (
        <View style={styles.indivContainer}>
          <Text style={styles.itemText}>{"P.S: " + additionalNote}</Text>
        </View>
      )}
      <View style={styles.indivContainer}>
        <TouchableOpacity
          ...
          onPress={handleChat}
        >
          <Text style={styles.chatText}>Chat & Buy!</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.indivContainer}>
        <TouchableOpacity
